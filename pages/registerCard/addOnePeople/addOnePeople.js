      ...
      if (isIsTrue) {
        ...
        if (isPhoneNum) {
          ...
          if (pageType == 1) {
            ...
            wx.redirectTo({
              url: '../addCustomer/addCustomer?userName=' + userName + "&cardType=" + cardType + "&cardTypeId=" + cardTypeId + "&cardNo=" + cardNo + "&phoneNum=" + phoneNum + "&photoPath=" + photoPath + "&path=" + path + "&isTrue=" + isTrue
            })
          }
        } else {
          wx.showToast({
