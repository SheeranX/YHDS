...
Page({
  ...
  recommand:function() {
    ...
    if (_this.data.isUnbind) {
      ...
      wx.navigateTo({
        url: 'share/share?id=' + _this.data.cardInfo.customerCodeId + '&isSend=true',
      })
    }
  },
  showModal:function(){
  ...
  purchasedAndGive:function(){
    wx.navigateTo({
      url: '../registerCard/registerCard?flag=true',
    })
  },
  bindUser:function(){
    let _this = this;
    ...
    {
      wx.navigateTo({
        url: '../bindCard/enterCardNo/enterCardNo',
      })
    }
  },
  /**
